...
Gem::Specification.new do |s|
  ...
  s.files = ["ext/swift/db/sqlite3/statement.c", "ext/swift/db/sqlite3/typecast.c", "ext/swift/db/sqlite3/datetime.c", "ext/swift/db/sqlite3/adapter.c", "ext/swift/db/sqlite3/common.c", "ext/swift/db/sqlite3/result.c", "ext/swift/db/sqlite3/main.c", "ext/swift/db/sqlite3/adapter.h", "ext/swift/db/sqlite3/statement.h", "ext/swift/db/sqlite3/typecast.h", "ext/swift/db/sqlite3/common.h", "ext/swift/db/sqlite3/result.h", "ext/swift/db/sqlite3/datetime.h", "ext/swift/db/sqlite3/extconf.rb", "test/helper.rb", "test/test_adapter.rb", "lib/swift-db-sqlite3.rb", "README.md", "CHANGELOG"]
